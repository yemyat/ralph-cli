export const PROMPT_PLAN = `0a. Study \`specs/*\` with up to 250 parallel subagents to learn the application specifications.
...
export const PROMPT_BUILD = `0a. Study \`specs/*\` with up to 500 parallel subagents to learn the application specifications.
